...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<Iaq68pqkq74cp>, false, never>;
        /**
...
type ICalls = {
    ...
    Utility: {
         ...
         * event is deposited.
         */
        batch: TxDescriptor<Anonymize<I1tse791u9sn2a>>;
        /**
         ...
         */
        as_derivative: TxDescriptor<Anonymize<I49fvsgt2f7le>>;
        /**
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<I1tse791u9sn2a>>;
        /**
         ...
         * - O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I5a3o42g6gr9qr>>;
        /**
         * Send a batch of dispatch calls.
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I1tse791u9sn2a>>;
        /**
         ...
         * The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I8dd7vf2og7lm2>>;
        /**
         ...
         * or both.
         */
        if_else: TxDescriptor<Anonymize<Ico425hf42db4h>>;
        /**
         * Dispatches a function call with a provided origin.
         *
         ...
         * The dispatch origin for this call must be _Root_.
         */
        dispatch_as_fallible: TxDescriptor<Anonymize<I5a3o42g6gr9qr>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<I9jelufmf59qiu>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<Ifjal8q0vct7et>>;
        /**
         * Register approval for a dispatch to be made from a deterministic composite account if
         * approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<Icrlp1plvd2fg2>>;
        /**
         ...
         * - `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<Ibm5uousonsura>>;
        /**
...
type IViewFns = {
    ...
    Proxy: {
         ...
         */
        check_permissions: RuntimeDescriptor<[call: Anonymize<Ifecum7a5t6kt5>, proxy_type: Anonymize<Ieuemnllefri8h>], boolean>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Uint8Array], Anonymize<Icbehqsbn6kpnk>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<Ifecum7a5t6kt5>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<Ifecum7a5t6kt5>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call V2.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I9g869l9vmunib>, call: Anonymize<Ifecum7a5t6kt5>, result_xcms_version: number], Anonymize<I7atek0l6pnr7i>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<If60jogo7dkbr1>>;
    };
    /**
...
export type Ksm_pplDispatchError = Anonymize<If8ol865vkvlvc>;
type IAsset = PlainDescriptor<void>;
export type Ksm_pplExtensions = {};
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type Ksm_ppl = {
    ...
    asset: IAsset;
    extensions: Ksm_pplExtensions;
    getMetadata: () => Promise<Uint8Array>;
    genesis: string | undefined;
};
declare const _allDescriptors: Ksm_ppl;
export default _allDescriptors;
export type Ksm_pplApis = ApisFromDef<IRuntimeCalls>;
export type Ksm_pplQueries = QueryFromPalletsDef<PalletsTypedef>;
export type Ksm_pplCalls = TxFromPalletsDef<PalletsTypedef>;
export type Ksm_pplEvents = EventsFromPalletsDef<PalletsTypedef>;
export type Ksm_pplErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type Ksm_pplConstants = ConstFromPalletsDef<PalletsTypedef>;
export type Ksm_pplViewFns = ViewFnsFromPalletsDef<PalletsTypedef>;
export type Ksm_pplCallData = Anonymize<Ifecum7a5t6kt5> & {
    value: {
        type: string;
    };
};
