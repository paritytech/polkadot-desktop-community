...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I876dqi9c1hgmj>, false, never>;
        /**
...
type ICalls = {
    ...
    Whitelist: {
         ...
         */
        dispatch_whitelisted_call_with_preimage: TxDescriptor<Anonymize<If37f83qskhjh0>>;
    };
    Parameters: {
        /**
    ...
    Utility: {
         ...
         * event is deposited.
         */
        batch: TxDescriptor<Anonymize<I7v1062qealmhj>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        as_derivative: TxDescriptor<Anonymize<Icn2452equp98f>>;
        /**
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<I7v1062qealmhj>>;
        /**
         ...
         * - O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<Iekeidmjri0rbq>>;
        /**
         * Send a batch of dispatch calls.
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I7v1062qealmhj>>;
        /**
         ...
         * The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I82v4o7dn9dlts>>;
        /**
         ...
         * or both.
         */
        if_else: TxDescriptor<Anonymize<I1jjgvrc6qf3hv>>;
        /**
         * Dispatches a function call with a provided origin.
         *
         ...
         * The dispatch origin for this call must be _Root_.
         */
        dispatch_as_fallible: TxDescriptor<Anonymize<Iekeidmjri0rbq>>;
    };
    Society: {
        /**
    ...
    Recovery: {
         ...
         */
        as_recovered: TxDescriptor<Anonymize<I2600qjm5jgqvm>>;
        /**
    ...
    Scheduler: {
         ...
         */
        schedule: TxDescriptor<Anonymize<I7fe2tgkm9193l>>;
        /**
         ...
         */
        schedule_named: TxDescriptor<Anonymize<I42i57b4hnjk5t>>;
        /**
         ...
         */
        schedule_after: TxDescriptor<Anonymize<I4cddodnmt91ot>>;
        /**
         * Schedule a named task after a delay.
         */
        schedule_named_after: TxDescriptor<Anonymize<Idq6uvn3od6g39>>;
        /**
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<I4kukav09ko639>>;
        /**
         ...
         * - `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<I7pms2090ggi15>>;
        /**
    ...
    Multisig: {
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<I6nh8qhg7ulabe>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<I9fkija0t0mns3>>;
        /**
         * Register approval for a dispatch to be made from a deterministic composite account if
         * approved by a total of `threshold - 1` of `other_signatories`.
         *
...
type IEvent = {
    System: {
         ...
         * An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<Ish27g0kkmboj>>;
        /**
         * `:code` was updated.
         */
         ...
         */
        RejectedInvalidAuthorizedUpgrade: PlainDescriptor<Anonymize<Ieqnojn7n9b1hd>>;
    };
    Indices: {
        /**
    ...
    Whitelist: {
         ...
         */
        WhitelistedCallDispatched: PlainDescriptor<Anonymize<Icnaha7ks8bqq2>>;
    };
    Parameters: {
        /**
         * A Parameter was set.
    ...
    Utility: {
         ...
         * well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<I63mk6of7i4t5j>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<Icgg1k98gpdl3q>>;
        /**
         * A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I5re8mq52693ih>>;
        /**
         ...
         */
        IfElseFallbackCalled: PlainDescriptor<Anonymize<Ieirmak8uk2mgt>>;
    };
    Society: {
        /**
    ...
    Scheduler: {
         ...
         */
        Dispatched: PlainDescriptor<Anonymize<I1n70qnrig22fo>>;
        /**
    ...
    Proxy: {
         ...
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I5re8mq52693ih>>;
        /**
         * A pure account has been created by new proxy with given
         * disambiguation index and proxy type.
         */
        PureCreated: PlainDescriptor<Anonymize<I9ia1u4jhnjg0g>>;
        /**
    ...
    Multisig: {
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<Iarbgtf68ut38>>;
        /**
    ...
    FastUnstake: {
         ...
         */
        Unstaked: PlainDescriptor<Anonymize<Ib1ffg5r7okns6>>;
        /**
    ...
    StakingAhClient: {
         ...
         */
        SessionKeysUpdateFailed: PlainDescriptor<Anonymize<I4s2oofj5f87rg>>;
    };
    ParaInclusion: {
        /**
    ...
    Crowdloan: {
         ...
         */
        HandleBidResult: PlainDescriptor<Anonymize<Ici2gn3agii0cs>>;
        /**
...
type IViewFns = {
    Proxy: {
         ...
         */
        check_permissions: RuntimeDescriptor<[call: Anonymize<Icl38i184jp9u6>, proxy_type: Anonymize<Inpglg3f6qcjg>], boolean>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Uint8Array], Anonymize<Idr6kskfblcm10>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<Icl38i184jp9u6>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<Icl38i184jp9u6>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call V2.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I782539geqqo66>, call: Anonymize<Icl38i184jp9u6>, result_xcms_version: number], Anonymize<I295hi5ngpmpfo>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<Ia2psdur0pam1>>;
    };
    /**
...
export type KsmDispatchError = Anonymize<Ibefjna6t0mkm5>;
type IAsset = PlainDescriptor<void>;
export type KsmExtensions = {};
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type KsmCallData = Anonymize<Icl38i184jp9u6> & {
    value: {
        type: string;
    };
};
...
export type KsmWhitelistEntry = PalletKey | `query.${NestedKey<AllInteractions['storage']>}` | `tx.${NestedKey<AllInteractions['tx']>}` | `event.${NestedKey<AllInteractions['events']>}` | `error.${NestedKey<AllInteractions['errors']>}` | `const.${NestedKey<AllInteractions['constants']>}` | `view.${NestedKey<AllInteractions['viewFns']>}` | `api.${NestedKey<AllInteractions['apis']>}`;
type PalletKey = `*.${({
