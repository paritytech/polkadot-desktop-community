...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Uint8Array], Anonymize<I4kraub1pfqlrf>>;
        /**
...
export type Dot_pplDispatchError = Anonymize<I3i0q0iii2v8bq>;
type IAsset = PlainDescriptor<Anonymize<If9iqq7i64mur8>>;
export type Dot_pplExtensions = {};
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type Dot_ppl = {
    ...
    asset: IAsset;
    extensions: Dot_pplExtensions;
    getMetadata: () => Promise<Uint8Array>;
    genesis: string | undefined;
};
declare const _allDescriptors: Dot_ppl;
export default _allDescriptors;
export type Dot_pplApis = ApisFromDef<IRuntimeCalls>;
export type Dot_pplQueries = QueryFromPalletsDef<PalletsTypedef>;
export type Dot_pplCalls = TxFromPalletsDef<PalletsTypedef>;
export type Dot_pplEvents = EventsFromPalletsDef<PalletsTypedef>;
export type Dot_pplErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type Dot_pplConstants = ConstFromPalletsDef<PalletsTypedef>;
export type Dot_pplViewFns = ViewFnsFromPalletsDef<PalletsTypedef>;
export type Dot_pplCallData = Anonymize<I8kpscpnfj8ea9> & {
    value: {
        type: string;
    };
};
...
export type Dot_pplWhitelistEntry = PalletKey | `query.${NestedKey<AllInteractions['storage']>}` | `tx.${NestedKey<AllInteractions['tx']>}` | `event.${NestedKey<AllInteractions['events']>}` | `error.${NestedKey<AllInteractions['errors']>}` | `const.${NestedKey<AllInteractions['constants']>}` | `view.${NestedKey<AllInteractions['viewFns']>}` | `api.${NestedKey<AllInteractions['apis']>}`;
type PalletKey = `*.${({
