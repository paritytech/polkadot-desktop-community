...
describe('transportGateway.decodeEventsFromChatMessage iOS VoIP token', () => {
  ...
  it('decodes an iOSVoIP push token (platform index 2) without a decode failure', () => {
    ...
    const events = transportGateway.decodeEventsFromChatMessage(bytes);
...
describe('transportGateway.decodeEventsFromChatMessage acceptedAt', () => {
