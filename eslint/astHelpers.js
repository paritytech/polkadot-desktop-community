 ...
 * @returns {boolean}
 */
export function isImportedFrom(node, importSources, scope) {
 ...
 * @returns {import('estree').Identifier | null}
 */
export function getCalleeNameFromExpression(node) {
  if (isIdentifier(node.callee)) {
    return node.callee;
  }
